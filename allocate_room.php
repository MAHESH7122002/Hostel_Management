...
<?php
   if (isset($_POST['search'])) {
   	   ...
   	   $query_search = "SELECT * FROM Application WHERE Student_id like '$search_box%' and Hostel_id = '$hostel_id' and Application_status = 0";
...
<section class="contact py-5">
	<div class="container">
			<div class="mail_grid_w3l">
				<form action="allocate_room_new.php" method="post">
					<div class="row"> 
...
if(isset($_POST['submit'])){
   ...
   while($row1 = mysqli_fetch_assoc($result1)){
     ...
     $student_id = $row1['Student_id'];
     $query3 = "UPDATE Application SET Application_status = 1,Room_No = '$room_no' WHERE Student_id = '$student_id'";
